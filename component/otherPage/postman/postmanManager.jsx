...
class PostmanManager extends Component {
    ...
    if (file !== undefined) {
      ...
      reader.onload = () => {
        ...
        for (let i = 0; i < text.length; i++) {
          ...
          if (i === 0) {
            // First row contains "name", "date", "mail"
  ...
  handleSubmitForm = (event) => {
    ...
    otherPageService
      .checkGmail(this.state.emailAccount)
      .then((response) => {
            ...
            otherPageService
              ...
              .then(() => {
                if (i === len - 1) {
                  ...
                  if (tmpSent.length === 0) this.setState({ wrong: true });
                }
              });
          }
        } else {
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <div
            style={{ display: "block", marginTop: "0.5em", marginLeft: "2em" }}
          >
            <label>
              Key:　
              <input
        ...
        {wrongKey ? (
          <div className="alert alert-warning" style={{ marginTop: "2em" }}>
            {" "}
            Wrong key!{" "}
          </div>
        ) : (
        ...
        {warnSubject ? (
          <div className="alert alert-warning" style={{ marginTop: "2em" }}>
            {" "}
            Please provide subject of the mail!{" "}
          </div>
        ) : (
          <></>
        )}
        ...
        {!registered ? (
          <React.Fragment>
            ...
            <div className="alert alert-danger">
              {" "}
              check if there's any type error!
            </div>
          </React.Fragment>
        ) : (
          <></>
        ...
        {sent ? (
          <div className="progress" style={{ marginTop: "3em", height: "3em" }}>
            <div
              ...
              role="progressbar"
              style={{ width: barLen, fontSize: "2em" }}
              aria-valuenow={barLen}
              aria-valuemin="0"
              aria-valuemax="100"
            >
              {barLen}
